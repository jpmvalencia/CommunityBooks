...
class R_Options(QMainWindow):
    def __init__(self, previous):
        ...
        # Definir los botones
        self.go_to_signin = QPushButton("Ver Usuario")
        ...
        # Botones
        self.go_to_book = QPushButton("Ver Libro")
        ...
        self.go_to_location = QPushButton("Ver Ubicación")
        ...
        self.go_to_library = QPushButton("Ver Librería")
        ...
        self.go_to_booking = QPushButton("Ver Reservas")
