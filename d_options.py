...
class D_Options(QMainWindow):
    def __init__(self, previous):
        ...
        # Definir los botones
        self.go_to_signin = QPushButton("Eliminar Usuario")
        ...
        # Botones
        self.go_to_book = QPushButton("Eliminar Libro")
        ...
        self.go_to_location = QPushButton("Eliminar Ubicación")
        ...
        self.go_to_library = QPushButton("Eliminar Librería")
        ...
        self.go_to_booking = QPushButton("Eliminar Reservas")
